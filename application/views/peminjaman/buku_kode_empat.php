...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    <?php if(!empty($error_msg_buku_empat)): ?>
                        <div class="alert alert-danger" role="alert">
                            <?= $error_msg_buku_empat ?>
                        </div>
                    <?php endif ?> 
                    ...
                    <form action="<?= base_url("peminjaman/get_buku_empat") ?>" method="POST">
                        <div class="row mb-4 mt-2">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="kode_buku_empat" class="form-control" required>
                            </div>
                            <div class="col-sm-1">
                ...
                <div class="col-6 border-left">
                    <form action="<?php echo base_url("peminjaman/simpan_buku_tiga") ?>" method="post">
                        <div class="row mb-4 mt-2">
                            <div class="col-12">
                                <div class="row">
                                ...
                                <?php endif ?>
                                <?php  if(!empty($kode_buku_tiga)) : ?>
                                    <input type="hidden" name="kode_buku_tiga" value="<?php echo $kode_buku_tiga ?>">
                                <?php endif ?>
