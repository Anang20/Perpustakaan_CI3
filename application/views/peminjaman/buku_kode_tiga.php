...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    <?php if(!empty($error_msg_buku_tiga)): ?>
                    ...
                    <form action="<?= base_url("peminjaman/get_buku_tiga") ?>" method="POST">
                        <div class="row mb-4 mt-2">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="kode_buku_tiga" class="form-control" required>
                            </div>
                            <div class="col-sm-1">
                ...
                <div class="col-6 border-left">
                    <form action="<?= base_url("peminjaman/simpan_buku_dua") ?>" method="post">
                        <div class="row mb-4 mt-2">
                            <div class="col-12">
                                <div class="row">
                                ...
                                <?php endif ?>
                                <?php  if(!empty($kode_buku_dua)) : ?>
                                    <input type="hidden" name="kode_buku_dua" value="<?php echo $kode_buku_dua ?>">
                                <?php endif ?>
