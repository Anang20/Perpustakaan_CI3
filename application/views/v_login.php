                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="<?= base_url('assets/img/library.gif'); ?>" alt="" style="padding-left: 50px; background-color: transparent; width: 450px; height: 400px;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="<?= base_url('Login/prosesLogin'); ?>" method="POST" class="user">
