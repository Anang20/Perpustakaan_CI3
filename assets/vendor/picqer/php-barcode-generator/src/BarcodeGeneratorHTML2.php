...
class BarcodeGeneratorHTML2 extends BarcodeGenerator
{
    /**
     ...
     */
    public function getBarcode($barcode, $type, int $widthFactor = 1, int $height = 20, string $foregroundColor = 'black')
    {
